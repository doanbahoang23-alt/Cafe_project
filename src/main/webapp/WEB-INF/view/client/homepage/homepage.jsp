                    ...
                    <body>
                                    ...
                                    <ul class="navbar-nav ms-auto">
                                        ...
                                        <sec:authorize access="isAuthenticated()">
                                            <li class="nav-item"><a class="nav-link text-warning"
                                                    href="/employee/dashboard"><i class="bi bi-box-arrow-in-right"></i>
                                                    Quản lý</a></li>
                                        </sec:authorize>
                                        <sec:authorize access="!isAuthenticated()">
                        ...
                        <section class="hero-section text-center">
                            <div class="container">
                                ...
                                <p class="lead mb-4">Nơi tận hưởng hương vị cà phê nguyên bản và những phút giây thư
                                    giãn
                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 px-md-5">
                                        ...
                                        <p class="text-muted">Với mong muốn mang lại một không gian làm việc và trò
                                            chuyện
                                            lý tưởng, chúng tôi không ngừng cải thiện chất lượng dịch vụ và không gian
                                            quán.
                                        ...
                                        <ul class="list-unstyled mt-4">
                                            <li><i class="bi bi-check-circle-fill text-success me-2"></i> Không gian
                                                rộng
                                                rãi, thoáng mát</li>
                                            <li><i class="bi bi-check-circle-fill text-success me-2"></i> Đồ uống đa
                                                dạng,
                                                pha chế chuyên nghiệp</li>
                                            <li><i class="bi bi-check-circle-fill text-success me-2"></i> Wifi tốc độ
                                                cao
                                                miễn phí</li>
                                        </ul>
                                    </div>
                        ...
                        <footer class="bg-dark text-white py-4">
                            <div class="container text-center">
                                ...
                                <p class="text-muted small">Hotline: 0123.456.789 | Địa chỉ: Nhổn, Bắc Từ Liêm, Hà Nội
                                </p>
                            </div>
                        </footer>
